...
(defrule whitespace (mkpr #(System.Char/IsWhiteSpace %)))

(defrule digit    (mkpr #(System.Char/IsDigit         %)))
(defrule alpha    (mkpr #(System.Char/IsLetter        %)))
(defrule alphanum (mkpr #(System.Char/IsLetterOrDigit %)))
